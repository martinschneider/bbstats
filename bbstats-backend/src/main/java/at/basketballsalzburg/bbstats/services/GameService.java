...
public interface GameService {
	 ...
	 * @param game
	 *            {@link GameDTO}
	 * @return true, if no result has been entered. always false, if the game
	 *         has been penalized
	 */
	 ...
	 * @param game
	 *            {@link GameDTO}
	 * @return true, if one of the periods ended 0:0 (which is usually very
	 *         unlikely to happen but usually indicates an error during entering
	 *         the results)
	 */
	 ...
	 * @param game
	 *            {@link GameDTO}
	 * @return true, if the sum of the players' points does not match the team
	 *         score. always false, if the game has been penalized
	 */
	 ...
	 * @param game
	 *            {@link GameDTO}
	 * @return true, if the player stats are missing. always
	 *         returns false in case the game has been penalized
	 */
