/*
 * Apache License Version 2.0, January 2004 http://www.apache.org/licenses/ Copyright 2009 by chenillekit.org Licensed
...
public class DateSelector extends AbstractField
{
    ...
    protected void processSubmission(String elementName)
    {
        ...
        {
            calendar
                .set(Integer.parseInt(rawYearValue), Integer.parseInt(rawMonthValue), Integer.parseInt(rawDayValue));
