...
public class PageLayout {
	...
	@Component(parameters = {
			"homepageURL=literal:http://www.basketball-salzburg.at",
	...
	void afterRender() {
		...
		if (!isAuthenticated()) {
			javaScriptSupport.require("jquery-vegas");
		}
	}
	...
	void buildMenu() {
		if (!menu.isInitialized()) {
			...
			games = MenuHelper.addItem(games, messages.get("schedule"),
					Schedule.class);
			games = MenuHelper.addItem(games, messages.get("results"),
					Results.class);
			...
			MenuItem statistics = new MenuItem(messages.get("statistics"),
					null, true);
			statistics = MenuHelper.addItem(statistics,
					messages.get("gameStatistics"), GameStatistics.class);
			statistics = MenuHelper.addItem(statistics,
					messages.get("practiceStatistics"),
			...
			MenuItem maintenance = new MenuItem(messages.get("maintenance"),
					null, true);
			maintenance = MenuHelper.addItem(maintenance,
					messages.get("agegroups"), AgeGroupMaintenance.class);
			maintenance = MenuHelper.addItem(maintenance,
					messages.get("coaches"), CoachMaintenance.class);
			maintenance = MenuHelper.addItem(maintenance, messages.get("gyms"),
					GymMaintenance.class);
			maintenance = MenuHelper.addItem(maintenance,
					messages.get("players"), PlayerMaintenance.class);
			maintenance = MenuHelper.addItem(maintenance,
					messages.get("leagues"), LeagueMaintenance.class);
			maintenance = MenuHelper.addItem(maintenance,
					messages.get("teams"), TeamMaintenance.class);
